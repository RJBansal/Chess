...
public class Rook extends ChessPiece
{
     ...
     * it belongs to. 
     */
    public Rook(String owner, ChessLocation intialLocation, ChessGame game)
    {
    ...
    { 
        if(get_row() == newLocation.get_row() || get_col() == newLocation.get_col()){ 
    ...
    protected void updateThreateningLocation(ChessLocation newLocation){
        ...
        int col = newLocation.get_col() + 0;
        for(int i = distanceYP; i > 1; i--){ 
